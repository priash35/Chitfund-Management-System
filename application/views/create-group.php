                                ...
                                <div class="<?php echo $tab_pane1;?>" id="home1">
									<div class="col-md-20 row">
										<div class="col-md-6">
												<div class="card-box">
													...
													<?php  } ?>	
														...
														<div class="form-group row">
															<label class="col-3 col-form-label">Group Type</label>
															<div class="col-9">														  
															...
															<div class="form-group row">
																...
																<div class="col-9">
																<input type="text" class="form-control" value="<?php if(isset($group_duration)){ echo $group_duration;}?>" id="group_duration" name="group_duration" >
																</div>
															</div>
															<div class="form-group row">
															...
															<?php  } ?>
															<div class="form-group row">
																<label class="col-5 col-form-label">Commencement Date</label>
																<div class="col-6">
										...
										<div class="col-md-12 text-center">
													...
													<a  href="<?php echo base_url(); ?>Report/parse_byelaw/<?php echo $id;?>">View Bye Law</a>
													<?php  }else{ ?>	
													 ...
													 <form name="registration" id="myform1" action="<?php echo base_url()?>Group/edit_Group	" method="post" enctype="multipart/form-data">
														...
														<?php  } ?>	
															...
															<div class="form-group row">
																...
																<div class="col-8">																
																<input type="text" class="form-control" id="bank_name" name="bank_name" value="<?php if(isset($bank_name)){ echo $bank_name;}?>">
															...
															<div class="form-group row">
																...
																<div class="col-8">
																	<input type="text" class="form-control" id="branch_name" name="branch_name" value="<?php if(isset($branch_name)){ echo $branch_name;}?>">
															...
															<div class="form-group row">
																...
																<div class="col-8">
																	<input type="text" class="form-control" id="account_number" name="account_number" value="<?php if(isset($account_number)){ echo $account_number;}?>">
