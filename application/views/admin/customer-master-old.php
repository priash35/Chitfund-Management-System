												...
												<div class="card-box">
													...
													<form name="myform" id="myform" action="<?php echo base_url()?>Customer/add_Custdata" method="post" enctype="multipart/form-data">
														...
														<div class="form-group row">
															...
															<div class="col-9">
																<input type="text" id="f_name" name="f_name"  class="form-control" value="" required>
														...
														<div class="form-group row">
															...
															<div class="col-9">
																<input type="text" id="m_name" name="m_name"  class="form-control" value="" required>
														...
														<div class="form-group row">
															...
															<div class="col-9">
																<input type="text" id="l_name" name="l_name" class="form-control" value="" onfocusout="check_values()" required>
														...
														<div class="form-group row">
															...
															<div class="col-9">
																<textarea class="form-control" id="p_address" name="p_address" rows="5" required></textarea>
															</div>
														</div>
														<div class="form-group row">
														...
														<div class="form-group row">
															...
															<div class="col-9 row">
																...
																<div class="col-8">
																	<input class="form-control" type="tel" id="mobile_1" name="mobile_1" placeholder="Mobile Number 1"  maxlength="10" required><p id="error-message4" style="color:red;"></p>
																</div>
																<br><br>
																<label class="col-4 col-form-label">Mobile-2</label>
																<div class="col-8">
																	<input class="form-control" type="tel" id="mobile_2" name="mobile_2" maxlength="10" placeholder="Mobile Number 2">
																</div>
																<br><br>
																<label class="col-4 col-form-label">Mobile-3</label>
																<div class="col-8">
																	<input class="form-control" type="tel" id="mobile_3" name="mobile_3" maxlength="10" placeholder="Mobile Number 3">
																</div>
																<br><br>
																<label class="col-4 col-form-label">Mobile-4</label>
																<div class="col-8">
																	<input class="form-control" type="tel" id="mobile_4" name="mobile_4" maxlength="10" placeholder="Mobile Number 4">
																</div>
																<br><br>
																<label class="col-4 col-form-label">Landline</label>
																<div class="col-8">
																	<input class="form-control" type="tel" id="landline" name="landline" maxlength="10" placeholder="Landline Number" >
																</div>
															<br><br>
															</div>												
														</div>														
														...
														<div class="form-group row">
															...
															<div class="col-9">
																<div class="radio radio-info form-check-inline">
																	<input type="radio" id="inlineRadio1" value="Male" name="radioInline" required>
																	<label for="inlineRadio1"> Male </label>
																</div>
																<div class="radio radio-info form-check-inline">
																	<input type="radio" id="inlineRadio2" value="Female" name="radioInline" required>
