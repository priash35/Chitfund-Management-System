                    ...
                    <div id="navigation">
						...
						<ul class="navigation-menu">
                            <li class="has-submenu">
                                <a href="#">Masters<i class="fa fa-caret-down"></i></a>
                                <ul class="submenu">
                            ...
                            <li class="has-submenu active">
                                <a href="<?php echo base_url().'Admin/cust_master'; ?>">Customer Master</a>
                            </li>
                            <li class="has-submenu">
                                <a href="#">Manage Groups <i class="fa fa-caret-down"></i></a>
                                <ul class="submenu">
                                    <li ><a href="#">Group Master</a></li>
									<li ><a href="<?php echo base_url().'Admin/create_group'; ?>">Create Group</a></li>
                            ...
                            <li class="has-submenu">
                                <a href="#">Collection Entry <i class="fa fa-caret-down"></i></a>
                                <ul class="submenu">
                                    <li><a href="<?php echo base_url().'Admin/daily_collection'; ?>">Daily Collection</a></li>
                            ...
                            <li class="has-submenu">
                                <a href="#">Auction List <i class="fa fa-caret-down"></i></a>
                            </li>
							<li class="has-submenu">
                                <a href="#">Outstanding</a>
							</li>
							<li class="has-submenu">
                                <a href="#">FD Release  <i class="fa fa-caret-down"></i></a>
							</li>
                        </ul>
