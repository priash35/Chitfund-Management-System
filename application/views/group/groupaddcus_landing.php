...
<div class="wrapper">
            <div class="container-fluid">
                        ...
                        <div class="page-title-box">
                            <div class="btn-group pull-right">
                                <ol class="breadcrumb hide-phone p-0 m-0">
                                    ...
                                    <li class="breadcrumb-item active">Customer Selection</li>
                                </ol>
                            </div>
				...
				<div class="row">
                    <div class="col-12">
                        <div class="card-box">
							<h3 class="header-title m-t-0 m-b-30 text-center">Customer Selection</h3>
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered toggle-circle m-b-0" data-page-size="7">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $post->group_duration." ".$unit;?></td>
                                    ...
                                    <td><!-- <a  href="<?php echo base_url(); ?>Group/AddCusGroup/<?php echo $post->id;?>"><span class="btn btn-sm btn-default fa fa-plus"></span></a> -->
                                    <a  href="<?php echo base_url(); ?>Group/EditCusGroup/<?php echo $post->id;?>"><span class="btn btn-sm btn-default fa fa-edit"></span></a>
 ...
 <script type="text/javascript">
			...
			function delete_ins(ins_id)
			{
				...
				if(ins_id!="")
				{
					...
					if(conf)
					{
						window.location.href= "<?php echo site_url('Group/DeleteCusGroup');?>?id="+ins_id;;
